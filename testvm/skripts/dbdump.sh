...
docker exec $DOCKER_CONTAINER sh -c "mariadb-dump --all-databases --single-transaction --quick --routines --triggers --events --tz-utc -u root -p'rootpass'" > "$TARGET_PATH/db.sql"
